#Autor: csucreb
 ...
 Scenario Outline: Register on the Automation Demo Site
    ...
    Examples:
      ...
      |Claudia     |Barrios   |C:\Users\csucre\Pictures\usuario.png |CumbreAzul   |cbarrios4@gmail.com  |5076345784  |FeMale   |Movies  |Portuguese |C       |Argentina   |Japan      |1993        |July          |10         |Dorian19&   |Dorian19&       |- Double Click on Edit Icon to EDIT the Table Row. |